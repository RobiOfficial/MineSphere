...
## Documentation
MineSphere's documentation is available [here](https://github.com/RobiOfficial/MineSphere/wiki).

## Installation
You can find customization and installation guide on our [wiki](https://github.com/RobiOfficial/MineSphere/wiki).

## Contributing
Contributions are always welcome!  

See [the contribution guide](https://github.com/RobiOfficial/MineSphere/wiki/%E2%9C%8F%EF%B8%8F-Contribution-Guide) for ways to get started.

---

## License
MineSphere is licensed under the [GNU General Public License v3.0 or later](https://github.com/RobiOfficial/MineSphere?tab=GPL-3.0-1-ov-file).
